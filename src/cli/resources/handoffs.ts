...
registerResource({
  ...
  table: 'handoffs',
  description:
    'Trusted append-only handoff ledger. It binds one source agent, reviewer, project, goal, and fingerprint to a strict created→delivery receipt→reviewed→acknowledged→closed lifecycle.',
  idColumn: 'id',
  ...
  columns: [
    ...
    { name: 'review_outcome', type: 'string', description: 'Formal reviewer outcome.' },
